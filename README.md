...
Estructura bàsica de carpetas desarrollo web.

carpeta assets: que a su vez contiene la carpeta images donde estan contenidas todas las imagenes que vamos a enlazar a nuestro sitio o pàgina web

carpeta css: que contiene a nustro archivo main.css en el cual va la parte de la hoja de estilos con las propiedades css del nustra pàgina y la que se enlaza a nuestro archivo html.

Archivo index.html el cual se situa en la raiz de nuestra carpeta principal y en el cual contiene el codigo de marcado html de la estructura de la pàgina.
